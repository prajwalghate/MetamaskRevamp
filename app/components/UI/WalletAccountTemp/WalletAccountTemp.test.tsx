...
import WalletAccountTemp from './WalletAccountTemp';
...
describe('WalletAccountTemp', () => {
  it('renders correctly', () => {
    const { toJSON } = renderWithProvider(<WalletAccountTemp />, {
      state: initialState,
    });
  ...
  it('shows the account address', () => {
    const { getByTestId } = renderWithProvider(<WalletAccountTemp />, {
      state: initialState,
    });
